...
* Добавил отображение информации по итоговым суммам реализованного за месяц и за весь период
* Помесячное отображение на мобиле теперь не глючит из-за слишком длинных имен желаний.
* Сделал кнопки для мобилки для помесячного отображения
