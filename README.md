...
* -100% у ВТБ
* Добавить Maven Resource plugin чтобы сам копировал сборку себе в static
* Так же рост  РусГидро - 0, а процент 62. Как так-то?
...
* Проверить, что купоны / дивы в разделе доход множатся на купленную сумму и что туда не попадает план
* В календаре надо купоны / дивы множить на купленную сумму
* Из календаря убрать прошедшие месяцы
* Из календаря брать прошедшие годы и следующие
