...
# Что сделали:
* Кажется, догадался в чем источник бага двойного клика и уже даже порешал его со списком желаний. Осталось порешать остальные запросы. Так же исправил НПЕ с поиском.
