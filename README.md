...
* Пробежаться по остальным классам и поправить их
* Поправить все "тудушки"
* Группы
* Попробовать больше инфы заложить в токен
...
* Пробежаться по всем "тудушкам" на фронте и беке. Разрулить их все
* Разгребсти последний оставшийся контроллер - MainRestController.
