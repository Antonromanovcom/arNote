...
public class Wish {
    ...
    public Wish(long id, String wish, int price, int priority, boolean ac, String description, String url, com.antonromanov.arnote.sex.model.ArNoteUser user) {
    ...
    public Wish(String wish, int price, int priority, boolean archive, String description, String url, com.antonromanov.arnote.sex.model.ArNoteUser user) {
        this.wish = wish;
        this.price = price;
        this.priority = priority;
